проект написан на X++ для **Microsoft Dynamics AX 2012**. все версии: [ax3](SysResultSet/tree/ax3/), [ax4](SysResultSet/tree/ax4/), [ax2009](SysResultSet/tree/ax2009/), [ax2012](SysResultSet/tree/ax2012/)
